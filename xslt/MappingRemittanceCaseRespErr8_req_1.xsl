...
<!-- @generated mapFile="xslt/MappingRemittanceCaseRespErr8_req_1.map" md5sum="0d14cebb7dad2eafbefc23919b2f5de4" version="8.0.400" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor.
*
*   Mapping file:		MappingRemittanceCaseRespErr8_req_1.map
*   Map declaration(s):	MappingRemittanceCaseRespErr8_req_1
*   Input file(s):		smo://smo/name%3Dwsdl-primary/message%3D%257Bhttp%253A%252F%252FRemittance_JDBC_Common_Toolkit_Implementation%252FJDBCImport%257DupsertBpm_Sor_RemittanceT_Remittance_Case_InfoBGRequestMsg/xpath%3D%252F/smo.xsd
...
<xsl:stylesheet
    ...
    xmlns:out7="http://RSD"
    xmlns:map="http://Remittance_JDBC_Common_Toolkit_Implementation/xslt/MappingRemittanceCaseRespErr8_req_1"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:MappingRemittanceCaseRespErr8_req_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io3:smo" mode="map:MappingRemittanceCaseRespErr8_req_1"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io3:smo" to "io3:smo".  -->
  <xsl:template match="io3:smo"  mode="map:MappingRemittanceCaseRespErr8_req_1">
    <io3:smo>
      <body>
        <xsl:attribute name="xsi:type">
        ...
        <out:upsertCaseInfoResponse>
          <output1>
            <faultOut>
              ...
              <!-- a simple data mapping: "context/failInfo/failureString"(string) to "message"(string) -->
              <xsl:if test="context/failInfo/failureString">
                <xsl:element name="message">
                  <xsl:value-of select="context/failInfo/failureString"/>
                </xsl:element>
              </xsl:if>
              <!-- a simple data mapping: "context/failInfo/origin"(string) to "detail"(string) -->
  ...
  <xsl:template name="map:MappingRemittanceCaseRespErr8_req_12">
    <xsl:param name="smo"/>
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out2:upsertCaseInfoResponseMsg'"/>
      ...
      <out:upsertCaseInfoResponse>
        <output1>
          <faultOut>
            ...
            <!-- a simple data mapping: "$smo/context/failInfo/failureString"(string) to "message"(string) -->
            <xsl:if test="$smo/context/failInfo/failureString">
              <xsl:element name="message">
                <xsl:value-of select="$smo/context/failInfo/failureString"/>
              </xsl:element>
            </xsl:if>
            <!-- a simple data mapping: "$smo/context/failInfo/origin"(string) to "detail"(string) -->
