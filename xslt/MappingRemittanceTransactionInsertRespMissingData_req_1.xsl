...
<!-- @generated mapFile="xslt/MappingRemittanceTransactionInsertRespMissingData_req_1.map" md5sum="32e196b7a438cb63de1769464130e820" version="8.0.400" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor.
*
*   Mapping file:		MappingRemittanceTransactionInsertRespMissingData_req_1.map
*   Map declaration(s):	MappingRemittanceTransactionInsertRespMissingData_req_1
*   Input file(s):		smo://smo/name%3Dwsdl-primary/message%3D%257Bhttp%253A%252F%252FRemittance_JDBC_Common_Toolkit_Implementation%252FJDBCImport%257DcreateBpm_Sor_RemittanceRemittance_TransactionBGMissingDataFaultMsg/xpath%3D%252F/smo.xsd
...
<xsl:stylesheet
    ...
    xmlns:map="http://Remittance_JDBC_Common_Toolkit_Implementation/xslt/MappingRemittanceTransactionInsertRespMissingData_req_1"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:MappingRemittanceTransactionInsertRespMissingData_req_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io2:smo" mode="map:MappingRemittanceTransactionInsertRespMissingData_req_1"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io2:smo" to "io2:smo".  -->
  <xsl:template match="io2:smo"  mode="map:MappingRemittanceTransactionInsertRespMissingData_req_1">
    <io2:smo>
      <body>
        <xsl:attribute name="xsi:type">
        ...
        <out5:insertResponse>
          <output1>
            <faultOut>
              ...
              <!-- a simple data mapping: "body/in24:MissingDataFault_element/errorCode"(string) to "errCode"(string) -->
              <xsl:if test="body/in24:MissingDataFault_element/errorCode">
                <xsl:element name="errCode">
                  <xsl:value-of select="body/in24:MissingDataFault_element/errorCode"/>
                </xsl:element>
              </xsl:if>
              <!-- a simple data mapping: "body/in24:MissingDataFault_element/message"(string) to "message"(string) -->
              <xsl:if test="body/in24:MissingDataFault_element/message">
                <xsl:element name="message">
                  <xsl:value-of select="body/in24:MissingDataFault_element/message"/>
                </xsl:element>
              </xsl:if>
            </faultOut>
          </output1>
  ...
  <xsl:template name="map:MappingRemittanceTransactionInsertRespMissingData_req_12">
    <xsl:param name="smo"/>
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out6:insertResponseMsg'"/>
      ...
      <out5:insertResponse>
        <output1>
          <faultOut>
            ...
            <!-- a simple data mapping: "$smo/body/in24:MissingDataFault_element/errorCode"(string) to "errCode"(string) -->
            <xsl:if test="$smo/body/in24:MissingDataFault_element/errorCode">
              <xsl:element name="errCode">
                <xsl:value-of select="$smo/body/in24:MissingDataFault_element/errorCode"/>
              </xsl:element>
            </xsl:if>
            <!-- a simple data mapping: "$smo/body/in24:MissingDataFault_element/message"(string) to "message"(string) -->
            <xsl:if test="$smo/body/in24:MissingDataFault_element/message">
              <xsl:element name="message">
                <xsl:value-of select="$smo/body/in24:MissingDataFault_element/message"/>
              </xsl:element>
            </xsl:if>
          </faultOut>
        </output1>
