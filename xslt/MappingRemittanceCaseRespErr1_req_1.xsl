...
<!-- @generated mapFile="xslt/MappingRemittanceCaseRespErr1_req_1.map" md5sum="5bc1efcef7aaca44472cf64690f74b05" version="8.0.400" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor.
*
*   Mapping file:		MappingRemittanceCaseRespErr1_req_1.map
*   Map declaration(s):	MappingRemittanceCaseRespErr1_req_1
...
<xsl:stylesheet
    ...
    xmlns:out7="http://RSD"
    xmlns:map="http://Remittance_JDBC_Common_Toolkit_Implementation/xslt/MappingRemittanceCaseRespErr1_req_1"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:MappingRemittanceCaseRespErr1_req_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io3:smo" mode="map:MappingRemittanceCaseRespErr1_req_1"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io3:smo" to "io3:smo".  -->
  <xsl:template match="io3:smo"  mode="map:MappingRemittanceCaseRespErr1_req_1">
    <io3:smo>
      <body>
        <xsl:attribute name="xsi:type">
        ...
        <out:upsertCaseInfoResponse>
          <output1>
            <faultOut>
              ...
              <!-- a simple mapping with no associated source:  to "errCode"(string) -->
  ...
  <xsl:template name="map:MappingRemittanceCaseRespErr1_req_12">
    <xsl:param name="smo"/>
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out2:upsertCaseInfoResponseMsg'"/>
