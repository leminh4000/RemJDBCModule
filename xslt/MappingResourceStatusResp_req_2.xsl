...
<!-- @generated mapFile="xslt/MappingResourceStatusResp_req_2.map" md5sum="fd4de43cc1f0c7798818315c3661d8e3" version="8.0.400" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor.
*
*   Mapping file:		MappingResourceStatusResp_req_2.map
*   Map declaration(s):	MappingResourceStatusResp_req_2
*   Input file(s):		smo://smo/name%3Dwsdl-primary/message%3D%257Bhttp%253A%252F%252FRemittance_JDBC_Common_Toolkit_Implementation%252FJDBCImport%257DupsertBpm_Sor_RemittanceResource_StatusBGResponseMsg/xpath%3D%252Fbody/smo.xsd
*   Output file(s):		smo://smo/name%3Dwsdl-primary/message%3D%257Bhttp%253A%252F%252FRemittance_JDBC_Common_Toolkit_Library%252FResourceStatusIntf%257DupsertResourceStatusResponseMsg/xpath%3D%252Fbody/smo.xsd
*
...
<xsl:stylesheet
    ...
    xmlns:in9="http://www.ibm.com/xmlns/prod/websphere/j2ca/jdbc/bpm_sor_remittanceresource_status"
    ...
    xmlns:out3="http://Remittance_JDBC_Common_Toolkit_Library/ResourceStatusIntf"
    xmlns:out2="http://TCBT24Library"
    xmlns:out5="http://Remittance_JDBC_Common_Toolkit_Library/InsertRemittanceCase"
    xmlns:out4="wsdl.http://Remittance_JDBC_Common_Toolkit_Library/ResourceStatusIntf"
    xmlns:out="http://RSD"
    xmlns:out7="http://Remittance_JDBC_Common_Toolkit_Library/InsertRemittanceTransaction"
    xmlns:out9="http://Remittance_JDBC_Common_Toolkit_Library/ResourceStatusInt"
    xmlns:out8="wsdl.http://Remittance_JDBC_Common_Toolkit_Library/ResourceStatusInt"
    xmlns:map="http://RemJDBCModule/xslt/MappingResourceStatusResp_req_2"
  ...
  <xsl:template match="/">
    <xsl:choose>
        ...
        <msl:datamap>
          <xsl:element name="dataObject">
            <xsl:attribute name="xsi:type">
              <xsl:value-of select="'out4:upsertResourceStatusResponseMsg'"/>
            </xsl:attribute>
            <xsl:call-template name="map:MappingResourceStatusResp_req_22">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="body" mode="map:MappingResourceStatusResp_req_2"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "body" to "body".  -->
  <xsl:template match="body"  mode="map:MappingResourceStatusResp_req_2">
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out4:upsertResourceStatusResponseMsg'"/>
      </xsl:attribute>
      <out3:upsertResourceStatusResponse>
        <output1>
          <faultOut>
  ...
  <xsl:template name="map:MappingResourceStatusResp_req_22">
    <xsl:param name="body"/>
    <out3:upsertResourceStatusResponse>
      <output1>
        <faultOut>
