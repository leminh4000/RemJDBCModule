...
<!-- @generated mapFile="xslt/MappingCaseRelationshipResp_req_3.map" md5sum="1e28b286cb8790e27ef4c7c4108a92b0" version="8.0.400" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor.
*
*   Mapping file:		MappingCaseRelationshipResp_req_3.map
*   Map declaration(s):	MappingCaseRelationshipResp_req_3
...
*   Output file(s):		smo://smo/name%3Dwsdl-primary/message%3D%257Bhttp%253A%252F%252FRemittance_JDBC_Common_Toolkit_Library%252FCaseRelationshipIntf%257DupsertCaseRelationshipResponseMsg/xpath%3D%252Fbody/smo.xsd
*
...
<xsl:stylesheet
    ...
    xmlns:out3="wsdl.http://Remittance_JDBC_Common_Toolkit_Library/CaseRelationshipIntf"
    xmlns:out2="http://Remittance_JDBC_Common_Toolkit_Library/CaseRelationshipIntf"
    xmlns:out5="http://Remittance_JDBC_Common_Toolkit_Library/InsertRemittanceCase"
    xmlns:out4="http://TCBT24Library"
    xmlns:out="http://RSD"
    xmlns:out7="http://Remittance_JDBC_Common_Toolkit_Library/CaseRelationshipInt"
    xmlns:out8="wsdl.http://Remittance_JDBC_Common_Toolkit_Library/CaseRelationshipInt"
    xmlns:map="http://RemJDBCModule/xslt/MappingCaseRelationshipResp_req_3"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:MappingCaseRelationshipResp_req_32">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="body" mode="map:MappingCaseRelationshipResp_req_3"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "body" to "body".  -->
  <xsl:template match="body"  mode="map:MappingCaseRelationshipResp_req_3">
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out3:upsertCaseRelationshipResponseMsg'"/>
      </xsl:attribute>
  ...
  <xsl:template name="map:MappingCaseRelationshipResp_req_32">
    <xsl:param name="body"/>
    <out2:upsertCaseRelationshipResponse>
      <output1>
        <faultOut>
