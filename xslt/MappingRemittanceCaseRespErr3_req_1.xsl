...
<!-- @generated mapFile="xslt/MappingRemittanceCaseRespErr3_req_1.map" md5sum="e4ac7d98fe73f6e246eb8a8a169a0f54" version="8.0.400" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor.
*
*   Mapping file:		MappingRemittanceCaseRespErr3_req_1.map
*   Map declaration(s):	MappingRemittanceCaseRespErr3_req_1
*   Input file(s):		smo://smo/name%3Dwsdl-primary/message%3D%257Bhttp%253A%252F%252FRemittance_JDBC_Common_Toolkit_Implementation%252FJDBCImport%257DupsertBpm_Sor_RemittanceT_Remittance_Case_InfoBGUniqueConstraintFaultMsg/xpath%3D%252F/smo.xsd
...
<xsl:stylesheet
    ...
    xmlns:out7="http://RSD"
    xmlns:map="http://Remittance_JDBC_Common_Toolkit_Implementation/xslt/MappingRemittanceCaseRespErr3_req_1"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:MappingRemittanceCaseRespErr3_req_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io3:smo" mode="map:MappingRemittanceCaseRespErr3_req_1"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io3:smo" to "io3:smo".  -->
  <xsl:template match="io3:smo"  mode="map:MappingRemittanceCaseRespErr3_req_1">
    <io3:smo>
      <body>
        <xsl:attribute name="xsi:type">
  ...
  <xsl:template name="map:MappingRemittanceCaseRespErr3_req_12">
    <xsl:param name="smo"/>
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out2:upsertCaseInfoResponseMsg'"/>
