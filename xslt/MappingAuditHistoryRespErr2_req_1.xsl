...
<!-- @generated mapFile="xslt/MappingAuditHistoryRespErr2_req_1.map" md5sum="986616d25cf986caf648c6c172af84cf" version="8.0.400" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor.
*
*   Mapping file:		MappingAuditHistoryRespErr2_req_1.map
*   Map declaration(s):	MappingAuditHistoryRespErr2_req_1
*   Input file(s):		smo://smo/name%3Dwsdl-primary/message%3D%257Bhttp%253A%252F%252FRemittance_JDBC_Common_Toolkit_Implementation%252FJDBCImport%257DupsertBpm_Sor_RemittanceT_Remittance_Audit_HistoryBGUniqueConstraintFaultMsg/xpath%3D%252F/smo.xsd
...
<xsl:stylesheet
    ...
    xmlns:map="http://RemJDBCModule/xslt/MappingAuditHistoryRespErr2_req_1"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:MappingAuditHistoryRespErr2_req_12">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io3:smo" mode="map:MappingAuditHistoryRespErr2_req_1"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io3:smo" to "io3:smo".  -->
  <xsl:template match="io3:smo"  mode="map:MappingAuditHistoryRespErr2_req_1">
    <io3:smo>
      <body>
        <xsl:attribute name="xsi:type">
        ...
        <out4:upsertAuditHistoryResponse>
          <output1>
            <faultOut>
              ...
              <!-- a simple data mapping: "body/in28:UniqueConstraintFault_element/errorCode"(string) to "errCode"(string) -->
              <xsl:if test="body/in28:UniqueConstraintFault_element/errorCode">
                <xsl:element name="errCode">
                  <xsl:value-of select="body/in28:UniqueConstraintFault_element/errorCode"/>
                </xsl:element>
              </xsl:if>
              <!-- a simple data mapping: "body/in28:UniqueConstraintFault_element/message"(string) to "message"(string) -->
              <xsl:if test="body/in28:UniqueConstraintFault_element/message">
                <xsl:element name="message">
                  <xsl:value-of select="body/in28:UniqueConstraintFault_element/message"/>
                </xsl:element>
              </xsl:if>
            </faultOut>
          </output1>
  ...
  <xsl:template name="map:MappingAuditHistoryRespErr2_req_12">
    <xsl:param name="smo"/>
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out:upsertAuditHistoryResponseMsg'"/>
      ...
      <out4:upsertAuditHistoryResponse>
        <output1>
          <faultOut>
            ...
            <!-- a simple data mapping: "$smo/body/in28:UniqueConstraintFault_element/errorCode"(string) to "errCode"(string) -->
            <xsl:if test="$smo/body/in28:UniqueConstraintFault_element/errorCode">
              <xsl:element name="errCode">
                <xsl:value-of select="$smo/body/in28:UniqueConstraintFault_element/errorCode"/>
              </xsl:element>
            </xsl:if>
            <!-- a simple data mapping: "$smo/body/in28:UniqueConstraintFault_element/message"(string) to "message"(string) -->
            <xsl:if test="$smo/body/in28:UniqueConstraintFault_element/message">
              <xsl:element name="message">
                <xsl:value-of select="$smo/body/in28:UniqueConstraintFault_element/message"/>
              </xsl:element>
            </xsl:if>
          </faultOut>
        </output1>
